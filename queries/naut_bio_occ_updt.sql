  ...
  from(select 
   ...
   case when substr(p2.data,6,2) in ('01','02','03') then '1' 
        ...
        when substr(p2.data,6,2) in ('07','08','09') then '3' 
             ...
             cast(p7.peso_amostrado_comprimentos as DECIMAL(10,2)) peso_am_comprimentos,
             cast(p7.peso_amostrado_pesos as DECIMAL(10,2)) peso_am_pesos,
             cast(p7.peso_amostrado_contagens as DECIMAL(10,2)) peso_am_contagens,
             coalesce(p7.peso_amostrado_comprimentos, 0) + coalesce(p7.peso_amostrado_pesos, 0) + coalesce(p7.peso_amostrado_contagens, 0) peso_am_spp,
